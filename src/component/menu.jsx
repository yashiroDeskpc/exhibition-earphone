...
function HamburgerMenu() {
    ...
    const toggleMenu = () => {
        setIsOpen(!isOpen);
        if (!isOpen) {
            document.body.style.overflow = "hidden"; // メニューが開いたときにスクロールを無効にする
        } else {
            document.body.style.overflow = "auto"; // メニューが閉じたときにスクロールを有効にする
        }
    };
    ...
    // コンポーネントがアンマウントされる時にoverflowをリセット
    useEffect(() => {
        return () => {
    ...
    return (
        <>
            <div className="hamburger-menu">
                <div
                    className={`header_btn ${isOpen ? "open" : ""}`}
                    onClick={toggleMenu}
                >
                    ...
                    <div className="category-list">
                        ...
                        <div className="category-section">
                            ...
                            <ul className={openSections.purchase ? "open" : ""}>
                                <li>
                                    <Link to="/LP" className="menu-lp-nav">
                                        eイヤホンの買取サービス
                                    </Link>
                                </li>
                                <li>無料査定のお申込み</li>
